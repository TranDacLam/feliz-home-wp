...
function r_scripts_styles()
{
    ...
    wp_enqueue_script('jquery.min.js', THEME_URL . '/assets/js/jquery.min.js', array(), 1, true);
    wp_enqueue_script('bootstrap.min.js', THEME_URL . '/assets/js/bootstrap.min.js', array(), 1, true);
    wp_enqueue_script('wow.min.js', THEME_URL . '/assets/js/wow.min.js', array(), 1, true);
    wp_enqueue_script('jquery.validate.min.js', THEME_URL . '/assets/js/jquery.validate.min.js', array(), 1, true);
    wp_enqueue_script('sweet-alert.min.js', THEME_URL . '/assets/js/sweet-alert.min.js', array(), 1, true);
    wp_enqueue_script('carousel.min.js', THEME_URL . '/assets/js/owl.carousel.min.js', array(), 1, true);
    wp_enqueue_script('fullpage.js', THEME_URL . '/assets/js/fullpage.js', array(), 1, true);
    wp_enqueue_script('jquery.fancybox.min.js', THEME_URL . '/assets/js/jquery.fancybox.min.js', array(), 1, true);
    wp_enqueue_script('lazyload.min.js', THEME_URL . '/assets/js/lazyload.min.js', array(), 1, true);

    wp_enqueue_script('main.js', THEME_URL . '/assets/js/main.js', array('jquery'), $version, true);
